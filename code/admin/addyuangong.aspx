<%@ Page Title="" Language="C#" MasterPageFile="~/code/MasterPage3.master" AutoEventWireup="true" CodeFile="addyuangong.aspx.cs" Inherits="code_admin_addguanhong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <td>
        <table class="auto-style21">
            <tr>
                <td colspan="3" style="background-color: #99CCFF" class="auto-style26">员工信息录入</td>
            </tr>
            <tr>
                ...
                <td rowspan="6">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="yno" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="100%">
